...
public class LadderViewGroup extends FrameLayout {
    ...
    public LadderViewGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public LadderViewGroup setStateBackgroundColor(int normal, int pressed, int unable) {
    ...
    public LadderViewGroup setBackgroundColorNormal(int colorNormal) {
    ...
    public LadderViewGroup setBackgroundColorPressed(int colorPressed) {
    ...
    public LadderViewGroup setBackgroundColorUnable(int colorUnable) {
    ...
    public LadderViewGroup setBorderWidthNormal(int width) {
    ...
    public LadderViewGroup setBorderColorNormal(int color) {
    ...
    public LadderViewGroup setBorderWidthPressed(int width) {
    ...
    public LadderViewGroup setBorderColorPressed(int color) {
    ...
    public LadderViewGroup setBorderWidthUnable(int width) {
    ...
    public LadderViewGroup setBorderColorUnable(int color) {
    ...
    public LadderViewGroup setCornerRadiusTopLeft(float topLeft) {
    ...
    public LadderViewGroup setCornerRadiusTopRight(float topRight) {
        this.mCornerRadius = -1;
    ...
    public LadderViewGroup setCornerRadiusBottomRight(float bottomRight) {
        this.mCornerRadius = -1;
    ...
    public LadderViewGroup setCornerRadiusBottomLeft(float bottomLeft) {
        this.mCornerRadius = -1;
